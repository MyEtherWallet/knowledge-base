...
**Step 4.** Head to the ‘My Wallets’ area of the extension and click the small icon that looks like an eye. Если вы остановите на нем курсор, то должна появиться надпись «Посмотреть».

**Step 5.** Enter in the password you just made.

**Step 6.** You will be taken to an area that shows your wallet’s information. В этом разделе вы можете скачать новый файл хранилища ключей (JSON-файл) и использовать его для доступа в будущем.
