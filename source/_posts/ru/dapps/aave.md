...
###### Если вы хотите занимать или класть на депозит с помощью Aave, вам понадобится кошелек, в который вы можете [получить доступ с помощью нашего интерфейса](/@@@@@@/getting-started/how-to-access-your-wallet/). If you do not have a wallet, check out out guide on [how to create a wallet](/@@@@@@/getting-started/how-to-create-a-wallet/) to set one up.
