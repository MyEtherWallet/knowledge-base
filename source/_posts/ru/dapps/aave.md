...
Aave позволяет вам класть на депозит и занимать 16 разных видов криптовалют, зарабатывая проценты на вложенном залоге. Borrowed assets will accrue an annual interest that needs to be paid back when you’re done with the loan, but this accrual can be switched between a variable or stable rate..
...
<img src="/images/posts/diving-deeper/aave1.png" alt="Изображение Aave на странице Dapps" width="100%" />
...
<img src="/images/posts/diving-deeper/aave6.png" alt="Изображение страницы займов Aave" width="100%" />
...
<img src="/images/posts/diving-deeper/aave13.png" alt="Изображение фактора здоровья после выплаты" width="80%" />
