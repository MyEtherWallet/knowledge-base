...
###### If you’d like to open a Collateralized Debt Position (CDP) using our MakerDAO Dapp, you will need a wallet you can [access with our interface](/@@@@@@/Getting_Started/how-to-access-your-wallet/). If you do not have a wallet, [click here](/@@@@@@/Getting_Started/How_To_Create_A_Wallet/) to set one up.
