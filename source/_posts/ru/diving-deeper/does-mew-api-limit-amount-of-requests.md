...
([Источник](https://ethereum.stackexchange.com/questions/24737/myetherwallet-json-rpc-interface-ratelimiting/25113#25113))
...
Наша цель — позволить людям взаимодействовать с платформой Ethereum, а не обеспечивать детально проработанную инфраструктуру, удовлетворяющую все пожелания. Этого должно быть более чем достаточно для использования одним человеком, однако вы можете без колебаний связаться с нами и объяснить, почему вам нужно больше, и мы сможем внести изменения.
