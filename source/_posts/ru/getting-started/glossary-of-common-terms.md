...
-   Также как в Вашем аккаунте Reddit существует имя пользователя (публичное) и пароль (закрытый), так и в аккаунте Ethereum есть открытый и закрытый ключ. Для повышения безопасности вы можете использовать пароль для шифрования закрытого ключа, в результате чего у вас будет имя пользователя (публичное), пароль (закрытый) и пароль для этого пароля (закрытый + более безопасный). Этот метод называется [доступ с помощью файла хранилища ключа](/@@@@@@/security-and-privacy/what-is-a-keystore-file/).
...
-   Посмотрите категорию [Аппаратные Кошельки](/@@@@@@/hardware-wallets/using-ledger-with-mew/) для получения дополнительной информации о аппаратных кошельках.
...
-   [Первый пример Identicon](http://i.imgur.com/lHUrIiZ.jpg)
-   [Второй пример Identicon ](http://i.imgur.com/FvyLewS.jpg)
...
-   Мнемонические фразы из 24 слов — это также 256 бит энтропии. 2048 слов в словаре. 11 бит энтропии (слова). `11 * 24 = 264`. Последнее слово — контрольное, или checksum (подробнее о [руководстве по контрольным checksums](/@@@@@@/common-issues/not-checksummed/)).
...
-   Ознакомьтесь с нашей статьей о [смарт-контрактах](/@@@@@@/diving-deeper/what-is-a-smart-contract/).
