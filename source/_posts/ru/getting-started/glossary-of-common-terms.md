...
##### *Here is a list of terms you may encounter while using MyEtherWallet (MEW).  
You can also [read in Spanish](https://github.com/faraggi/words-are-hard-es/blob/master/words-are-hard-es.md), thanks to faraggi.*
