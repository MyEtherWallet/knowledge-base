...
**Шаг 5.** Здесь есть опция для дополнительного слова для дополнительной безопасности. Choosing to include an extra word keeps your phrase more secure, but it limits the accessibility of your phrase with other wallets. Другие кошельки могут не использовать дополнительное слово, что делает вашу фразу несовместимой.
