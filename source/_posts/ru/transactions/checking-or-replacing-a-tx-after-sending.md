...
**Шаг 8.** Появится диалоговое окно. Внимательно прочитайте всю показанную информацию. Click the "Yes, I'm Sure" button to send.

**Шаг 9.** Появится хеш новой транзакции. Click the link to view it and see if you were successful. Если она не появится сразу, попробуйте обновить страницу через несколько минут.
