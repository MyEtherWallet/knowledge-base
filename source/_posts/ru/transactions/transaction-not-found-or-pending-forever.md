...
## __Другие советы__
* Попробуйте переключить сеть в правом верхнем углу, чтобы использовать другой узел. Есть несколько узлов, с помощью которых вы можете взаимодействовать с ETH. We default to 'MyEtherWallet.com'. Если один из них не работает, то попробуйте другой.
