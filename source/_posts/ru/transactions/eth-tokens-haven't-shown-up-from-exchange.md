...
# **Не появились токены ETH или ERC20, отправленные на биржу или с нее**
...
Список стандартных ошибок и то, как их исправить, можно найти в нашей категории [частых проблем](/@@@@@@/common-issues/).