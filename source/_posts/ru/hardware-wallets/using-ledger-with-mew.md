...
**Шаг 3.** В этом разделе вы увидите "Данные контракта". Убедитесь, что эта опция установлена на “Yes”.
...
**Шаг 5.** Проверьте URL-адрес SSL сертификата MyEtherWallet Inc [US], чтобы убедиться, что вы на нашем настоящем безопасном сайте. Вы уверены? Отлично! Перейдите к пункту ‘Доступ к моему кошельку’ и выберите пункт ‘Аппаратные кошельки’. Нажмите на ‘Ledger Wallet’ и выберите ‘Подключить устройство’, когда Ledger будет подключен, разблокирован и готов к работе.
