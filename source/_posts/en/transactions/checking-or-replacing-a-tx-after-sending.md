...
**Step 1.** Head to an Ethereum blockchain explorer, like [Etherscan.io][es], [Ethplorer.io][ep], or [EthVM][ethvm].
...
-   **Transaction Not Found:** This transaction cannot be found. It's possible that it did not go through, or that it cannot be found in the Ethereum blockchain explorer you are using. Try using the other one ([Etherscan.io][es], [Ethplorer.io][ep], or [EthVM][ethvm]). If you still can't find it, it never went through.
...
If your transaction says 'Pending', check the gas price you used for this transaction and compare it to the gas prices seen on [EthGasStation.info][gas]. If it's much lower than the 'Safe Low' price listed, then you have a good chance of replacing or canceling it.
...
**Step 1.** Head to [Etherscan.io][es], [Ethplorer.io][ep], or [EthVM][ethvm].
