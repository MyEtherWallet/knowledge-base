...
-   Check out our [Hardware Wallet category][hwWallets] for more information about Hardware Wallets.
...
-   24-Word mnemonic phrases are also 256 bits of entropy. 2048 words in the dictionary. 11 bits of entropy (the words). `11 * 24 = 264`. The last word is a checksum (check out our [guide on checksums][checkSum] for more information).
...
-   Check out our article about [smart contracts][smartContracts].
